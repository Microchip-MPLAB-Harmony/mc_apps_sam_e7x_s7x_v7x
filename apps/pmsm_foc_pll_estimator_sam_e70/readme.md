...
To clone or download this application from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/motor_control) and then click **Clone** button to clone this repository or download as zip file.
